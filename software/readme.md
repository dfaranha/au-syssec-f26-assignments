...
Submit a short report (up to 7 pages in total, 12-point font, double-column format) detailing your observations, with due date on 24/04/2026. In your report, document the attacker model (conditions in which the vulnerability can be exploited), the security properties that were violated and explain how the vulnerability was fixed.
